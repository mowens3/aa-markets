...
from markets.models import Owner
from markets.tests.utils import create_test_holding
from markets.views._helpers import user_has_owner_in_corp
...
class TestCorporation(TestCase):
    ...
    def test_auditor_and_superuser_can_access_all(self):
        """
        Auditors and superusers should be able to access any markets
        """
        ...
        self.assertTrue(auditor_user.has_perm("markets.auditor"))
